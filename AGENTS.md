...
to `main`: builds (Debug + Release), runs tests with coverlet coverage, and
enforces two coverage gates (see Testing below). The Release job also
publishes the single-file exe.
